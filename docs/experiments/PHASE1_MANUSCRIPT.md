...
| **Wikitext（5060 CUDA，动机）** | `benchmark_wikitext_5060_cuda_n8_c12_20260407.json`、`benchmark_wikitext_5060_cuda_n16_c8_20260407.json`、`benchmark_wikitext_5060_cuda_n16_c12_20260407.json` | **HF naive** Mamba；**不可**与上行 3090 fused **同表混点** |
