...
| P1 | S1–S4 + SSGS×Mamba + 树×因果 LM | S1–S4；**SSGS×Mamba** **X-20260421-ssgs-mamba-dfs-demo**；**树路径×tiny-gpt2** **X-20260422-tree-lm-minimal**；大叶数 **A-20260408-research-large-leaves-3090**、探针 **X-20260408-probe-mamba2-3090-fused** |
