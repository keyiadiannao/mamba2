...
| P1 | S1/S2/S3 路径协议 | S1 **X-20260421-mamba2-cache-segments-{cpu,cuda}**；S2 **X-20260421-tf-r1-path-segments-cuda**；S3 **`benchmark_tf_kv_path_segments.py`** CUDA JSON 待登记；大叶数 **A-20260408-research-large-leaves-3090**、探针 **X-20260408-probe-mamba2-3090-fused** |
