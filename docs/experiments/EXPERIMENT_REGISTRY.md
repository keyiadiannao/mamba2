...
| X-20260410-ssgs-dryrun | 2026-04-10 | 5060 | — | X | P1 SSGS 假状态导航 + 测量协议 §7 | `src/rag_tree/ssgs.py`；`python -m unittest tests.test_ssgs` | 无 LM；`RESEARCH_NOTES.md` §7 TF-R1/TF-KV 与快照字段 |
