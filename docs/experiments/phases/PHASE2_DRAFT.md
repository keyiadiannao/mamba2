...
| 2026-04-10 | **§1**：**dim256** **`0847Z` minimal**；**SSGS grid 11 行**、**0845Z**。**§2**：**A2-S3** **0820Z/0850Z** 复跑 + **TSV 摘要**；与 **登记册**、**`PHASE1_MANUSCRIPT` §5/§8** 对齐 |
