...
1. **P0 冻结叙事**：将 **§A3 六轴** + **§A2.1** 句式 **粘贴进 LaTeX/Word** 脚注或方法段；**Figure 1** 三张 PNG 与 **CSV** 已在仓内 — **勿再改文件名**。**核对** 正文或附录已出现 **M1** 一句：**`ssgs_vs_kv_wikitext_nav_grid.csv`**（**三臂 DFS**、**玩具 TF-KV** **≠** path-batch **reader**；可选 **L3** 脚注见 **`SSGS_MAINLINE_M1.md`**）。  
...
| 2026-04-11 | **A2/A2.1/A3**：**M1** grid + **六轴**；**A8 §1**：**P0** 核对 **M1** 一句入正稿 |
