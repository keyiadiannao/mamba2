...
| P1 | **测量协议成文** | §7.1 + **分段 cache clone** 脚本（**`benchmark_mamba2_cache_snapshot_segments.py`**）；CPU **X-20260421-mamba2-cache-segments-cpu**、3090 fused **X-20260421-mamba2-cache-segments-cuda**；再后 **TF-R1 或 TF-KV** |
