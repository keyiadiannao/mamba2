...
| **检索头 B（分析）** | 支撑贡献候选 **②**；**B-S2** 脚本 + **`RETRIEVAL_HEAD_NOTES` §2** 文献表已具备；**per-head / 大模型** 仍待 **B-S3** 与机时 |
...
| **3** | **B-S1 / B-S2**：**`RETRIEVAL_HEAD_NOTES.md`**（§2 文献入口表 + §4 岭探针脚本） | **机制线** 与 **系统线** 叙事 **对齐**；精读与 **per-head** 仍属 **B-S3** |
